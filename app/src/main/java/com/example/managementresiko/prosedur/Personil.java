...
import com.example.managementresiko.ui.gallery.GalleryViewModel;
...
public class Personil extends Fragment {
    ...
    String kd_responden,jenis_tabel,kesesuaian_a1,kesesuaian_a2,kesesuaian_a3,kelengkapan_a1,kelengkapan_a2,kelengkapan_a3,deskripsi_a1,deskripsi_a2,deskripsi_a3;
    Spinner spn_kesesuaian_a1,spn_kesesuaian_a2,spn_kesesuaian_a3,spn_kelengkapan_a1,spn_kelengkapan_a2,spn_kelengkapan_a3;
    EditText txt_kondisi_a1,txt_kondisi_a2,txt_kondisi_a3;
    Button btn_simpan;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        root =  inflater.inflate(R.layout.fragment_personil, container, false);
        ...
        spn_kelengkapan_a1 = root.findViewById(R.id.a1_kelengkapan);
        spn_kelengkapan_a2 = root.findViewById(R.id.a2_kelengkapan);
        spn_kelengkapan_a3 = root.findViewById(R.id.a3_kelengkapan);

        spn_kesesuaian_a1 = root.findViewById(R.id.a1_kesesuaian);
        spn_kesesuaian_a2 = root.findViewById(R.id.a2_kesesuaian);
        spn_kesesuaian_a3 = root.findViewById(R.id.a3_kesesuaian);

        txt_kondisi_a1 = root.findViewById(R.id.a1_deskripsi);
        txt_kondisi_a2 = root.findViewById(R.id.a2_deskripsi);
        txt_kondisi_a3 = root.findViewById(R.id.a3_deskripsi);
